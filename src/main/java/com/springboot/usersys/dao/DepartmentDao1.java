...
public interface DepartmentDao1{
	 ...
	 * @return
	 */
    int updateDepartment1(@Param("enti") Department1 value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyDepartment1(@Param("enti") Department1 value, @Param("assist") Assist assist);
}