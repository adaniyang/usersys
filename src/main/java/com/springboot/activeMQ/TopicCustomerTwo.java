...
public class TopicCustomerTwo {
    ...
    public static void main(String[] args) {
        ...
        // 实例化连接工厂
        connectionFactory=new ActiveMQConnectionFactory(TopicCustomerTwo.USERNAME, TopicCustomerTwo.PASSWORD, TopicCustomerTwo.BROKEURL);
...
//            destination=session.createQueue("FirstQueue1"); // 创建消息队列
            ...
            consumer.setMessageListener(new TopicMyListenerTwo()); // 注册消息监听
        } catch (Exception e) {
