...
public interface AuditUserDao{
	 ...
	 * @return
	 */
    int updateAuditUser(@Param("enti") AuditUser value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyAuditUser(@Param("enti") AuditUser value, @Param("assist") Assist assist);
}
