 ...
 * The following code shows how to setup and use the mock backend when unit testing a api.
 * First we create the api under test:
 *
  <pre>
  // The api code
  ...
  <pre>
    ...
    describe('MyController', function() {
       ...
       beforeEach(inject(function($injector) {
         ...
         // The $api service is used to create instances of controllers
         var $api = $injector.get('$api');

         createController = function() {
           return $api('MyController', {'$scope' : $rootScope });
         };
       }));
       ...
       it('should send msg to server', function() {
         ...
         // the api will still send the request and
